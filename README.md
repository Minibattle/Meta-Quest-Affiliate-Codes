...
Automatically apply the 10% discount to EVERY game on the Quest store (including DLC's) using this [Firefox Extension!](https://addons.mozilla.org/en-CA/firefox/addon/metastore-affiliate-redirector/) Chrome extension coming soon (should hopefully be no longer than a week). The extension uses an exploit to enable the 10% off on EVERYTHING- even thinggs that are even missing from this github.
